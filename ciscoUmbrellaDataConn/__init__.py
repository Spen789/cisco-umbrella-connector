...
def main(mytimer: func.TimerRequest) -> None:
    ...
    if DIVIDE_TO_MULTIPLE_TABLES:
        sentinel_dict = {
        'dns': AzureSentinelConnector(logAnalyticsUri, sentinel_customer_id, sentinel_shared_key, sentinel_log_type + '_dns', queue_size=2000, bulks_number=3),
        'proxy': AzureSentinelConnector(logAnalyticsUri, sentinel_customer_id, sentinel_shared_key, sentinel_log_type + '_proxy', queue_size=2000, bulks_number=3),
        'ip': AzureSentinelConnector(logAnalyticsUri, sentinel_customer_id, sentinel_shared_key, sentinel_log_type + '_ip', queue_size=2000, bulks_number=3),
        'cloudfirewall': AzureSentinelConnector(logAnalyticsUri, sentinel_customer_id, sentinel_shared_key, sentinel_log_type + '_cloudfirewall', queue_size=2000, bulks_number=3),
        'firewall': AzureSentinelConnector(logAnalyticsUri, sentinel_customer_id, sentinel_shared_key, sentinel_log_type + '_firewall', queue_size=2000, bulks_number=3),
        'dlp': AzureSentinelConnector(logAnalyticsUri, sentinel_customer_id, sentinel_shared_key, sentinel_log_type + '_dlp', queue_size=2000, bulks_number=3),  # Added DLP
        'ravpn': AzureSentinelConnector(logAnalyticsUri, sentinel_customer_id, sentinel_shared_key, sentinel_log_type + '_ravpnlogs', queue_size=2000, bulks_number=3),
        'audit': AzureSentinelConnector(logAnalyticsUri, sentinel_customer_id, sentinel_shared_key, sentinel_log_type + '_audit', queue_size=2000, bulks_number=3),
        'ztna': AzureSentinelConnector(logAnalyticsUri, sentinel_customer_id, sentinel_shared_key, sentinel_log_type + '_ztna', queue_size=2000, bulks_number=3),
        'intrusion': AzureSentinelConnector(logAnalyticsUri, sentinel_customer_id, sentinel_shared_key, sentinel_log_type + '_intrusion', queue_size=2000, bulks_number=3),
        'ztaflow': AzureSentinelConnector(logAnalyticsUri, sentinel_customer_id, sentinel_shared_key, sentinel_log_type + '_ztaflow', queue_size=2000, bulks_number=3),
        'fileevent': AzureSentinelConnector(logAnalyticsUri, sentinel_customer_id, sentinel_shared_key, sentinel_log_type + '_fileevent', queue_size=2000, bulks_number=3)
                        }
        last_ts = None
        ...
        sentinel = AzureSentinelConnector(logAnalyticsUri, sentinel_customer_id, sentinel_shared_key, sentinel_log_type, queue_size=2000, bulks_number=3)
        with sentinel:
            for obj in sorted(obj_list, key=lambda k: k['LastModified']):
                cli.process_file(obj, dest=sentinel)
                last_ts = obj['LastModified']
...
class UmbrellaClient:
    ...
    def process_file(self, obj, dest):
        ...
        if 'csv.gz' in key.lower():
            ...
            # Fix: free compressed data immediately after unpacking
            del downloaded_obj
            ...
            if parser_func:
                ...
                # Fix: free decompressed CSV data and flush connector after each file
                del csv_file
                dest.flush()
